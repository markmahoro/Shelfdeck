...
const CAPABILITIES=Object.freeze([
  ...
  'arca.inventory.target_slot.prepare@1','arca.inventory.product.stage@1','arca.inventory.staged.verify@1','arca.inventory.final_product.verify@1','arca.inventory.placement.switch@1','arca.ondeck.fulfillment.verify@1','arca.ondeck.commit@1','arca.ondeck.input_settlement.delete@1'
]);
