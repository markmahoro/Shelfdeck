...
function directPage(context){const input=context.scope.directInput,entries=[['targetType',input.targetType],['targetId',input.targetId],['title',input.title],['year',input.year],['providerIdentity',input.providerIdentity],['rating',input.rating],['watched',input.watched],
    ['supersedesSourceRecordKey',input.supersedes?.sourceRecordKey||null],['supersedesSourceRecordRevision',input.supersedes?.sourceRecordRevision||null],['supersedesSourceRecordDigest',input.supersedes?.sourceRecordDigest||null],
    ['retractsSourceRecordKey',input.retracts?.sourceRecordKey||null],['retractsSourceRecordRevision',input.retracts?.sourceRecordRevision||null],['retractsSourceRecordDigest',input.retracts?.sourceRecordDigest||null]].map(([key,value])=>({key,value}));
