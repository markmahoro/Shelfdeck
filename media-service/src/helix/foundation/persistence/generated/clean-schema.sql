...
CREATE TABLE "arca_acceptance_attempts" (
  ...
  "related_disposition_set_digest" TEXT CHECK (length("related_disposition_set_digest") = 64 AND "related_disposition_set_digest" NOT GLOB '*[^0-9a-f]*'),
  "shelf_id" TEXT,
...
CREATE TABLE "arca_aftercare_cases" (
  ...
  UNIQUE ("shelf_entry_id", "care_basis_digest", "finding_set_digest", "care_requirement_digest", "case_generation"),
  UNIQUE ("shelf_entry_id", "trigger_digest"),
...
CREATE TABLE "arca_input_settlement_authorizations" (
  ...
  "authorization_scope_kind" TEXT CHECK ("authorization_scope_kind" IN ('old_primary_input', 'exclusive_related_input', 'old_primary_and_exclusive_related')),
  "actor_id" TEXT,
...
CREATE TABLE "arca_inventory_materials" (
  ...
  "material_key" TEXT,
  "role" TEXT CHECK ("role" IN ('primary_payload', 'structural_dependency', 'metadata_sidecar', 'poster', 'fanart', 'subtitle', 'external_audio', 'chapter', 'sidecar')),
...
CREATE UNIQUE INDEX "uidx_arca_inventory_materials_partial_01" ON "arca_inventory_materials" ("material_key") WHERE "role" = 'primary_payload' AND "active_guard" = 1;
...
CREATE TABLE "arca_inventory_related_references" (
  ...
  "role" TEXT,
  "reference_kind" TEXT CHECK ("reference_kind" IN ('shared_external', 'historical_provenance')),
...
CREATE TABLE "arca_material_bindings" (
  ...
  "material_key" TEXT,
  "role" TEXT,
  "authority_kind" TEXT CHECK ("authority_kind" IN ('product_control', 'related_derived')),
  "primary_material_key" TEXT,
  "source_related_reference_id" TEXT,
  "derived_authority_digest" TEXT CHECK (length("derived_authority_digest") = 64 AND "derived_authority_digest" NOT GLOB '*[^0-9a-f]*'),
  "episode_claims_schema_ref" TEXT,
  "episode_claims_json" TEXT,
  "episode_claim_set_digest" TEXT CHECK (length("episode_claim_set_digest") = 64 AND "episode_claim_set_digest" NOT GLOB '*[^0-9a-f]*'),
  "endpoint_id" TEXT,
...
CREATE TABLE "arca_ondeck_commit_receipts" (
  ...
  "control_revision_set_digest" TEXT CHECK (length("control_revision_set_digest") = 64 AND "control_revision_set_digest" NOT GLOB '*[^0-9a-f]*'),
  "related_disposition_completion_digest" TEXT CHECK (length("related_disposition_completion_digest") = 64 AND "related_disposition_completion_digest" NOT GLOB '*[^0-9a-f]*'),
  "commit_digest" TEXT CHECK (length("commit_digest") = 64 AND "commit_digest" NOT GLOB '*[^0-9a-f]*'),
  "committed_at_ms" INTEGER CHECK ("committed_at_ms" >= 0),
  UNIQUE ("on_deck_run_id"),
  FOREIGN KEY ("on_deck_run_id") REFERENCES "arca_ondeck_runs" ("on_deck_run_id") ON DELETE RESTRICT,
...
CREATE TABLE "arca_ondeck_settlement_approvals" (
  ...
  "on_deck_run_id" TEXT,
  "settlement_scope_digest" TEXT CHECK (length("settlement_scope_digest") = 64 AND "settlement_scope_digest" NOT GLOB '*[^0-9a-f]*'),
  "settlement_member_set_digest" TEXT CHECK (length("settlement_member_set_digest") = 64 AND "settlement_member_set_digest" NOT GLOB '*[^0-9a-f]*'),
  "source_to_final_mapping_digest" TEXT CHECK (length("source_to_final_mapping_digest") = 64 AND "source_to_final_mapping_digest" NOT GLOB '*[^0-9a-f]*'),
  "final_product_verification_digest" TEXT CHECK (length("final_product_verification_digest") = 64 AND "final_product_verification_digest" NOT GLOB '*[^0-9a-f]*'),
...
CREATE TABLE "fx_material_controls" (
  ...
  "updated_at_ms" INTEGER CHECK ("updated_at_ms" >= 0),
  UNIQUE ("mount_scope_id", "inode", "size_bytes", "fingerprint_algorithm", "fingerprint_version", "content_fingerprint")
);
...
CREATE TABLE "fx_reconcile_cursors" (
  "owner_domain" TEXT,
  "reconciler_key" TEXT,
  "revision" INTEGER CHECK ("revision" >= 1),
  "opaque_cursor" TEXT,
  "updated_at_ms" INTEGER CHECK ("updated_at_ms" >= 0),
  PRIMARY KEY ("owner_domain", "reconciler_key")
);
...
CREATE TABLE "libra_handoff_a_receipts" (
  ...
  "related_disposition_scope_digest" TEXT CHECK (length("related_disposition_scope_digest") = 64 AND "related_disposition_scope_digest" NOT GLOB '*[^0-9a-f]*'),
  "subject_id" TEXT,
...
CREATE TABLE "libra_material_bindings" (
  ...
  "material_key" TEXT,
  "role" TEXT,
  "authority_kind" TEXT CHECK ("authority_kind" IN ('primary_control', 'related_derived')),
  "primary_material_key" TEXT,
  ...
  "disposition_basis_digest" TEXT CHECK (length("disposition_basis_digest") = 64 AND "disposition_basis_digest" NOT GLOB '*[^0-9a-f]*'),
  "mount_scope_id" TEXT,
  "inode" TEXT,
  "fingerprint_algorithm" TEXT,
  "fingerprint_version" TEXT,
  ...
  "origin_related_disposition_scope_digest" TEXT CHECK (length("origin_related_disposition_scope_digest") = 64 AND "origin_related_disposition_scope_digest" NOT GLOB '*[^0-9a-f]*'),
  "current" INTEGER CHECK ("current" IN (0, 1)),
...
CREATE TABLE "libra_offload_context_materials" (
  ...
  "ordinal" INTEGER CHECK ("ordinal" >= 0),
  "material_key" TEXT,
  "context_role" TEXT CHECK ("context_role" IN ('original_input', 'structural_dependency', 'related_input')),
  "source_related_reference_id" TEXT,
  "final_product_material_key" TEXT,
  "disposition_kind" TEXT CHECK ("disposition_kind" IN ('carried_forward', 'replaced_and_settled')),
  "mount_scope_id" TEXT,
  "inode" TEXT,
  "size_bytes" INTEGER CHECK ("size_bytes" >= 0),
  "fingerprint_algorithm" TEXT,
...
CREATE TABLE "libra_product_fact_revisions" (
  ...
  "fact_digest" TEXT CHECK (length("fact_digest") = 64 AND "fact_digest" NOT GLOB '*[^0-9a-f]*'),
  "evidence_digest" TEXT CHECK (length("evidence_digest") = 64 AND "evidence_digest" NOT GLOB '*[^0-9a-f]*'),
  "source_basis_kind" TEXT CHECK ("source_basis_kind" IN ('decision_evidence', 'metadata_observation', 'western_analysis', 'western_match')),
...
CREATE TABLE "libra_product_package_materials" (
  ...
  "digest_hex" TEXT CHECK (length("digest_hex") = 64 AND "digest_hex" NOT GLOB '*[^0-9a-f]*'),
  "size_bytes" INTEGER CHECK ("size_bytes" >= 0),
  "control_operation" TEXT CHECK ("control_operation" IN ('assert_existing_input', 'assert_related_input', 'acquire_workspace_product')),
  ...
  CHECK ("workspace_handle_json" IS NULL OR length(CAST("workspace_handle_json" AS BLOB)) <= 16384),
  FOREIGN KEY ("on_deck_package_id") REFERENCES "libra_product_packages" ("on_deck_package_id") ON DELETE RESTRICT,
  FOREIGN KEY ("origin_intake_decision_id") REFERENCES "libra_intake_decisions" ("intake_decision_id") ON DELETE RESTRICT
);
...
CREATE TABLE "proc_candidate_related_references" (
  ...
  "endpoint_id" TEXT,
  "location" TEXT,
  "association_kind" TEXT CHECK ("association_kind" IN ('exclusive')),
  "disposition_required" INTEGER,
  "association_evidence_digest" TEXT CHECK (length("association_evidence_digest") = 64 AND "association_evidence_digest" NOT GLOB '*[^0-9a-f]*'),
  "disposition_basis_digest" TEXT CHECK (length("disposition_basis_digest") = 64 AND "disposition_basis_digest" NOT GLOB '*[^0-9a-f]*'),
  "reference_digest" TEXT CHECK (length("reference_digest") = 64 AND "reference_digest" NOT GLOB '*[^0-9a-f]*'),
  PRIMARY KEY ("candidate_package_id", "reference_id"),
  CHECK ("disposition_required" = 1),
  FOREIGN KEY ("candidate_package_id", "primary_ordinal") REFERENCES "proc_candidate_primary_materials" ("candidate_package_id", "ordinal") ON DELETE RESTRICT
);
...
CREATE TABLE "proc_procurement_runs" (
  ...
  "selected_material_count" INTEGER CHECK ("selected_material_count" >= 0),
  "selection_scope_count" INTEGER CHECK ("selection_scope_count" >= 0),
  "selection_scope_set_digest" TEXT CHECK (length("selection_scope_set_digest") = 64 AND "selection_scope_set_digest" NOT GLOB '*[^0-9a-f]*'),
  "retry_intent_id" TEXT,
...
CREATE TABLE "proc_run_materials" (
  ...
  "material_key" TEXT,
  "selection_role" TEXT,
  "field_relative_location" TEXT,
  "selection_scope_kind" TEXT CHECK ("selection_scope_kind" IN ('standalone_file', 'ordinary_directory', 'bdmv_container')),
  "selection_scope_key" TEXT,
  "selection_scope_root_relative_location" TEXT,
  "selection_scope_ordinal" INTEGER CHECK ("selection_scope_ordinal" >= 0),
  "scope_member_ordinal" INTEGER CHECK ("scope_member_ordinal" >= 0),
  "selection_scope_member_count" INTEGER CHECK ("selection_scope_member_count" >= 0),
  "selection_scope_member_set_digest" TEXT CHECK (length("selection_scope_member_set_digest") = 64 AND "selection_scope_member_set_digest" NOT GLOB '*[^0-9a-f]*'),
  "selection_scope_digest" TEXT CHECK (length("selection_scope_digest") = 64 AND "selection_scope_digest" NOT GLOB '*[^0-9a-f]*'),
  "mount_scope_id" TEXT,
  "inode" TEXT,
  "fingerprint_algorithm" TEXT,
  "fingerprint_version" TEXT,
