...
const CATALOG = Object.freeze({
  ...
  'media.transcode.precheck': def({}, TYPES.TRANSCODE_PRECHECK, 'pure', resource('transcode')),
  ...
  'media.transcode': def({ precheck: port(TYPES.TRANSCODE_PRECHECK) }, TYPES.STAGED_MEDIA_ASSET, 'staged_write', resource('transcode')),
