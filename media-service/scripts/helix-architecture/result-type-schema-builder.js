...
const special = {
  ...
  'RelatedMaterialReference.associationKind': { const: 'exclusive' },
  'RelatedMaterialReference.dispositionRequired': { const: true },
  'RelatedMaterialReference.dispositionBasisDigest': digest(),
  ...
  'LibraBindingDraft.bindings': arrayOf(object({
    ...
    authorityKind: enumText('primary_control', 'related_derived'),
    primaryMaterialKey: nullable(digest()), sourceRelatedReferenceId: nullable(id()),
    associationEvidenceDigest: nullable(digest()), dispositionBasisDigest: nullable(digest()),
  ...
  'LibraBindingDraftReceipt.producedAtMs': nonNegativeInteger(),
  ...
  'DeletionEvidence.disposition': enumText('deleted', 'authorized_identity_already_absent', 'retained_due_to_active_reference'),
  'DeletionEvidence.referenceReleaseResultDigest': nullable(digest()),
...
const contracts = {
  ...
  CandidatePackage: ['ManifestEnvelope', 'candidatePackageId,packageRevision,procurementRunId,runBasisDigest,triageRule,materialFieldContextRef,mediaType,contentProfile,materialInputForm,displayIdentity,identityMetadata,identityClaim,structureEvidenceRef,seasonContinuityClaims,seasonContinuityClaimSetDigest,primaryInputManifestRef,relatedReferences,relatedReferenceSetDigest,relatedDispositionScopeDigest,memberControlEvidenceSetDigest,packageDigest'],
  CandidatePublicationReceipt: ['ReceiptEnvelope', 'candidateDraftDigest,candidatePackageId,packageRevision,packageDigest,primaryInputManifestDigest,relatedReferenceSetDigest,relatedDispositionScopeDigest,memberControlEvidenceSetDigest,acceptanceBasisDigest,offerId,receiptDigest'],
  RelatedMaterialReference: [null, 'referenceId,primaryMaterialKey,role,identity,endpointId,location,fingerprintAlgorithm,fingerprintVersion,contentFingerprint,associationKind,dispositionRequired,associationEvidenceDigest,dispositionBasisDigest,referenceDigest'],
  SeasonContinuityClaim: [null, 'claimKind,claimNamespace,claimKey,claimDigest,evidenceDigest'],
  CandidateIntakeAcceptanceBasis: [null, 'handoffContractRef,acceptanceOwnerDomain,targetContext,candidatePackageId,packageRevision,packageDigest,primaryInputManifestDigest,seasonContinuityClaimSetDigest,relatedReferenceSetDigest,relatedDispositionScopeDigest,memberControlEvidenceSetDigest,acceptanceBasisDigest'],
  ...
  FinalProductVerification: ['VerificationEnvelope', 'finalBindingSetDigest,productManifestDigest,relatedDispositionSetDigest,verifiedMaterialKeys,targetContainmentDigest'],
  ...
  ReviewCandidateRevision: ['DomainFactEnvelope', 'candidateId,candidateKind,shelfEntryId?,duplicateGroupId?,targetDigest,policyRevision,conditionEvidenceDigest,reasonDigest,state'],
  ScopeVerification: ['VerificationEnvelope', 'destructionScopeId,inventoryRevision,controlRevisionSetDigest,memberSetDigest,memberCount'],
