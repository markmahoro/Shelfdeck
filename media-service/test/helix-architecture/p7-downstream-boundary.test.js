...
function ownerRows() {
  ...
  const candidatePackage={ schemaRef:PACKAGE_SCHEMA,schemaVersion:1,manifestId:'candidate-1',manifestKind:'candidate_package',
    ...
    materialFieldContextRef:{ fieldId:'field-1',accessRevision:1,contextDigest:D('context') },mediaType:'single',contentProfile:'movie',materialInputForm:'stream_file',
  ...
  return { offer, rows:{
    ...
    candidatePackage:{ candidate_package_id:'candidate-1',procurement_run_id:'run-1',package_revision:1,field_id:'field-1',
      field_access_revision:1,field_context_digest:D('context'),media_type:'single',content_profile:'movie',material_input_form:'stream_file',structure_kind:'single',
