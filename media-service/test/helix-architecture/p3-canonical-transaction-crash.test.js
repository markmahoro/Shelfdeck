...
test('canonical transaction inventory drives exactly 44 isolated contracts', () => {
  ...
  assert.equal(transactionContracts.length, 44);
  assert.equal(inventory.targetCount, 44);
