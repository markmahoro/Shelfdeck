...
export default function MediaPage() {
  ...
  return <Page>
    ...
    <Drawer open={!!selected} title={selected?.name || selected?.title || '媒体详情'} onClose={() => setSelected(null)}>{selected && <div className="stack">
      ...
      {selectedMaintenance.plannedFlowKind && <div><div className="field-label">实际执行方式</div><p>{directionLabels[selectedMaintenance.plannedFlowKind] || selectedMaintenance.plannedFlowKind}</p></div>}
