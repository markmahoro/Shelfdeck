...
| Status | P7-00–P7-05 PASS；current P7-06 Triage evidence pipeline |
...
| Next action | 实现P7-06 playability、structure、identity claim与primary manifest pure evidence pipeline |
