# ARCHIVE — 四类媒体 Helix Beta Feature Matrix（已作废）

> **本文已作废，不得作为 Helix-beta 验收权威。**
> 用户于 2026-08-22 确认：Helix-beta 仅为 Movie 全链路产品。
> 现行基线：`docs/helix/BETA_FEATURE_ACCEPTANCE_BASELINE.md`
> 架构 SSOT 仍定义 Series / JAV / Western Adult，那些 profile 属于 SSOT 与后续产品，不属于 Helix-beta 交付范围。

# ShelfDeck Helix Beta 功能验收基线（历史冻结稿）

Status: `SUPERSEDED / VOID`；原 `FROZEN` 于 2026-07-23；2026-08-22 由 Product Owner 作废  
