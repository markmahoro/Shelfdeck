...
Status: in progress；P2-00 in progress；standing P2–P13 Local Implementation authorization active.
...
| --- | --- | --- | --- |
| P2-00 | Standing authorization and isolated baseline receipt | in progress | P1 PASS |
| P2-01 | SSOT extraction oracle and source map | pending | P2-00 |
