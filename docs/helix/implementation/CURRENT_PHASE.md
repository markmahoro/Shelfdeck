...
Status: in progress; P1-00–P1-04 complete; P1-05 next; Local Implementation Gate open for P1 only.
...
| P1-05 | Forbidden legacy semantics guard | next | P1-01 |
...
当前没有P1 entry blocker。下一步执行P1-05；任何需要P2能力、E2E、Docker、生产、真实媒体副作用或
