...
Status: clean architecture accepted through `PBF-09-R1`; P0–P6 complete; P7 in progress under standing P2–P13 Local Implementation authorization; E2E, build, production and `media-desktop` changes paused.
