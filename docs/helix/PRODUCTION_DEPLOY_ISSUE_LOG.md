...
| PROD-019 | 收藏架拒收后没法放弃《影子写手》 | `USER_EXPERIENCE` / Handoff B 拒收后 Run 仍 active | 媒体整理工作区 | High | **FIXED** 无损升级 `helix-beta-20260829-bd5cc15b4`。刷新后可点放弃。 |
...
修复：Handoff B 业务拒收后，整理工作区直接放出「放弃整理」，Discard 允许 `active` + rejected Delivery Receipt。已无损升级 `helix-beta-20260829-bd5cc15b4`。刷新后可点放弃。
