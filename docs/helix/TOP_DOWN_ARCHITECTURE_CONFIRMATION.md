...
- `PBF-18`固定唯一的非循环构造顺序：先从expected head派生`packageRevision/onDeckPackageId`；再以该ID构造
  ...
  Product Material members并计算member/set/manifest digest，再计算Attestation、完整Package digest、Offer与Decision。
