...
| Deployment candidate commit | `83d3c4424` | 当前生产镜像内代码 |
| Latest deployed image | `markmahoro/shelfdeck:helix-beta-20260829-83d3c4424` | 2026-08-29 无损升级：预检、指纹 mtime、discard leftover、上架 checklist |
| Latest deployed commit | `83d3c4424` | PROD-014/015/016 |
| Latest deployed image SHA256 | `1265a473e7d4966610e547b9b530e24d407584ffdea2ba3fe8cfc1cc34c4de4f` | 本地 tar 与 NAS 上传校验 hash |
