          ...
          {configSection === 'policy' ? (
            <>
              ...
              <p className="hint">
                ...
                <strong> 80% </strong>
                时可<strong>洗版补源</strong>（与 5★4K 共用该比例）；<strong>5★</strong>不压缩，其中<strong>1080p 一律建议洗版</strong>，<strong>4K</strong>则仅在低于该80% 阈值时洗版。编辑后请保存。
              </p>
  ...
  if (page === 'mediaManage') {
    ...
    const mediaSidebar = (
      <>
        ...
        <p className="sidebarHint">
          目标码率梯度以配置中心<strong>媒体策略</strong>为准；星级取豆瓣优先、否则本地（见列表「星级状态」）。动作规则：1★删除档；2–3★仅压缩；4★可压缩或低于目标80%时洗版；5★不压缩、1080p 必洗版、4K 低于80% 时洗版。
        </p>
      </>
    );
