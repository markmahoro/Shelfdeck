...
- Helix-beta is the Movie-only full-chain product (SSOT journeys A–I, including Off-deck and Shelf Deregistration). The 2026-07-23 four-profile Feature Matrix is void; current Beta DoD is `docs/helix/BETA_FEATURE_ACCEPTANCE_BASELINE.md`. Series / JAV / Western Adult remain in the SSOT as later product scope, not Helix-beta claims. This never authorizes deleting those profiles from the SSOT.
...
- P1–P3 local implementation completed and passed their Exit Audits on 2026-07-16. The repaired P2 112/96/156/18 contract baseline aggregate is `aab78271f712df7714233f0a79e24453e0c1a85c5d214ebf926dc6e71adba247`; P3 froze the clean Persistence and atomic foundation, and P4 Execution and Recovery Foundation is active. The user granted standing autonomous Local Implementation authorization for P2–P13: after SSOT traceability, negative fixtures, and Phase Exit Audit all PASS, Codex may archive and enter the next Phase without waiting. This never authorizes SSOT changes, compatibility/dual paths, E2E, Docker/Canary, production, real-media effects, or `media-desktop`; only a genuine business decision or SSOT conflict is escalated.
